...
public class SurivalStatus : MonoBehaviour
{
    ...
    private void Start()
    {
        HealthManager.Instance.Decrease(25);
    }
    ...
    public void OnChangeStat(int survivalStatValue)
    {
        ...
        {
            case 0:
                HealthManager.Instance.isDegenHealth = true;

                HealthManager.Instance.isRegenHealth = false;
                break;

            case 50:
                HealthManager.Instance.isDegenHealth = false;

                HealthManager.Instance.isRegenHealth = true;
                break;
